...
def color_transfer(source, target, clips=True, preserve_paper=True):
	"""
	...
	# outside this range
	l = _scale_array(l, clips=clips)
	a = _scale_array(a, clips=clips)
	b = _scale_array(b, clips=clips)
...
def _scale_array(arr, clips=True):
	"""
...
ap.add_argument("-c", "--clips", type = str2bool, default = 't',
...
# to the target image
transfer = color_transfer(source, target, clips=args["clips"], preserve_paper=args["preservePaper"])
